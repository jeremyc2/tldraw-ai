---
title: "Using Cursor Agent CLI Headlessly"
description: "How to use Cursor Agent CLI in headless mode for long-running agent workflows."
author: "Cursor Team"
...
```
# Analyze an image
cursor-agent -p "Analyze this image and describe what you see: ./screenshot.png"

# Process multiple media files
cursor-agent -p "Compare these two images and identify differences: ./before.png ./after.png"

# Combine file paths with text instructions
cursor-agent -p "Review the code in src/app.ts and the design mockup in designs/homepage.png. Suggest improvements to match the design."
```
